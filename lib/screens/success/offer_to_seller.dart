...
class Offer_To_Seller_Screen extends StatefulWidget {
  const Offer_To_Seller_Screen({Key? key}) : super(key: key);

  @override
  State<Offer_To_Seller_Screen> createState() => _Offer_To_Seller_ScreenState();
}

class _Offer_To_Seller_ScreenState extends State<Offer_To_Seller_Screen> {
  @override
