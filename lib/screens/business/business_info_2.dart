              ...
              Container(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                        AppLocalizations.instance.text("loc_bus_head2"),
                    ...
                    Text(
                      AppLocalizations.instance.text("loc_bus_txt2"),
                      style: CustomWidget(context: context)
                          .CustomSizedTextStyle(
                          14.0,
                    ...
                    Form(child: Column(
                      ...
                      children: [
                        Text(
                          AppLocalizations.instance.text("loc_date_incorp"),
                          style: CustomWidget(context: context)
                              .CustomSizedTextStyle(
                              14.0,
                        ...
                        Text(
                            ...
                            AppLocalizations.instance.text("loc_state_incorp"),
                          style: CustomWidget(context: context)
                              .CustomSizedTextStyle(
                              14.0,
                              AppColors.blackColor,
                        ...
                        Text(
                          AppLocalizations.instance.text("loc_ein"),
                          style: CustomWidget(context: context)
                              .CustomSizedTextStyle(
                              14.0,
                              AppColors.blackColor,
                        ...
                        Text(
                            ...
                            AppLocalizations.instance.text("loc_no_own"),
                          style: CustomWidget(context: context)
                              .CustomSizedTextStyle(
                              14.0,
                              AppColors.blackColor,
