...
class AppColors {
  static const Color appColor =  Color(0xFFF5E100);
  static const Color backgroundColor =  Color(0xFFeceff1);
  static const Color list1Color =  Color(0xFFa7b5be);
  static const Color list2Color =  Color(0xFFb6c1c9);
  static const Color whiteColor =  Color(0xFFFFFFFF);
  static const Color whiteColor2 =  Color(0xFFFAFAFA);
  static const Color blackColor =  Color(0xFF171717);
  static const Color blackColor2 =  Color(0xFF262626);
  ...
  static const Color  iconColor =  Color(0xFF346698);
  static const Color  sellColor =  Color(0xFFfa8896);
  ...
  static const Color  smalltext2Color =  Color(0xFF737373);
